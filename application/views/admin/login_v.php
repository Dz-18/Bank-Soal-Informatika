...
<body class="bg-navy">
  <div class="wrapper">
    ...
    <form action="<?=site_url('Admin/data_soal')?>" method="post">
        ...
        <center><hr style="width: 200px;margin: 20px;"></center>
        <button class="btn mt-3" type="submit" name="login">Login</button>
    </form>
    <br>
    <h6 class="text-center" style="color: black">kembali ke <a href="<?=site_url('User/beranda')?>" style=""><b>BERANDA</b></a></h6>
  </div>
</body>
</html>